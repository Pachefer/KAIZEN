#!/usr/bin/env python3
"""
Script para extraer preguntas de MongoDB del archivo PDF
Basado en el libro "300+ MongoDB Interview Questions and Answers" de Salunke, Manish
"""
...
class MongoDBExtractor:
    def __init__(self, pdf_path):
        ...
        Args:
            pdf_path (str): Ruta al archivo PDF de MongoDB
        """
    ...
    def run_extraction(self, raw_output="mongodb_questions_raw.txt", 
                      structured_output="mongodb_questions_structured.json"):
        """
        ...
        """
        print("🚀 Iniciando extracción de preguntas de MongoDB")
        print("=" * 60)
...
def main():
    ...
    """
    # Configuración
    pdf_file = "300_ MongoDB Interview Questions and Answe - Salunke, Manish.pdf"
    raw_output = "mongodb_questions_raw.txt"
    structured_output = "mongodb_questions_structured.json"
    ...
    extractor = MongoDBExtractor(pdf_file)
