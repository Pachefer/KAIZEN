#!/usr/bin/env python3
"""
Script para ejecutar el proceso completo de React.js
...
def run_extraction():
    ...
    """
    return run_command(
        "python extract_react_questions.py",
        "Extrayendo preguntas del PDF de React.js"
    )
...
def run_processing():
    ...
    """
    return run_command(
        "python process_react_questions.py",
...
def generate_guides():
    ...
    if not os.path.exists("react_questions_processed.json"):
        print("❌ No se encontró el archivo react_questions_processed.json")
        print("💡 Ejecuta primero el procesamiento")
        return False
    
    print("✅ Archivos procesados encontrados")
    print("📖 Las guías ya están generadas en:")
    print("   - Guia_React_Avanzada.md")
    print("   - README.md")
...
def show_summary():
    ...
    files_to_check = [
        "react_questions_raw.txt",
        "react_questions_structured.json", 
        "react_questions_processed.json",
        "Guia_React_Avanzada.md",
        "README.md"
    ]
    ...
    print("\n📊 Estadísticas:")
    if os.path.exists("react_questions_processed.json"):
        import json
        with open("react_questions_processed.json", 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def main():
    ...
    """
    print("⚛️ PROCESO COMPLETO DE REACT.JS")
    print("=" * 60)
    ...
    print("📚 Las guías de React.js están listas para usar.")
