#!/usr/bin/env python3
"""
Script para ejecutar el proceso completo de React.js (300 preguntas)
...
def run_extraction():
    ...
    """
    return run_command(
        "python extract_react_300_questions.py",
        "Extrayendo preguntas del PDF de React.js (300 preguntas)"
    )
...
def run_processing():
    ...
    """
    return run_command(
        "python process_react_300_questions.py",
...
def generate_guides():
    ...
    if not os.path.exists("react_300_questions_processed.json"):
        print("❌ No se encontró el archivo react_300_questions_processed.json")
        print("💡 Ejecuta primero el procesamiento")
        return False
    
    print("✅ Archivos procesados encontrados")
    print("📖 Las guías ya están generadas en:")
    print("   - Guia_React_300_Avanzada.md")
    print("   - README.md")
...
def show_summary():
    ...
    files_to_check = [
        "react_300_questions_raw.txt",
        "react_300_questions_structured.json", 
        "react_300_questions_processed.json",
        "Guia_React_300_Avanzada.md",
        "README.md"
    ]
    ...
    print("\n📊 Estadísticas:")
    if os.path.exists("react_300_questions_processed.json"):
        import json
        with open("react_300_questions_processed.json", 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def main():
    ...
    """
    print("⚛️ PROCESO COMPLETO DE REACT.JS (300 PREGUNTAS)")
    print("=" * 60)
    ...
    print("📚 Las guías de React.js (300 preguntas) están listas para usar.")
