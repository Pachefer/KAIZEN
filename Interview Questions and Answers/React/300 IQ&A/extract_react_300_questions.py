#!/usr/bin/env python3
"""
Script para extraer preguntas de React.js del archivo PDF de 300 preguntas
Basado en el libro "300+ React.js Interview Questions and Answers" de Salunke, Manish
"""
...
class React300Extractor:
    def __init__(self, pdf_path):
        """
        Inicializa el extractor con la ruta del archivo PDF
        
        Args:
            pdf_path (str): Ruta al archivo PDF de React.js (300 preguntas)
        """
    ...
    def extract_questions(self):
        ...
        # Patrones para identificar preguntas (adaptados para 300 preguntas)
        question_patterns = [
    ...
    def categorize_questions(self):
        """
        Categoriza las preguntas por temas
        """
        ...
        keywords = {
            'fundamentos': ['react', 'jsx', 'virtual dom', 'component', 'library'],
            'componentes': ['component', 'functional', 'class', 'render'],
            'hooks': ['hook', 'useState', 'useEffect', 'useContext', 'useReducer'],
            'estado': ['state', 'setState', 'estado', 'mutation'],
            'props': ['props', 'prop', 'propagation', 'passing'],
            'eventos': ['event', 'handler', 'onClick', 'onChange', 'callback'],
            'ciclo_vida': ['lifecycle', 'mount', 'unmount', 'update', 'componentDidMount'],
            'routing': ['router', 'route', 'navigation', 'link', 'browser router'],
            'testing': ['test', 'jest', 'enzyme', 'testing library', 'mock'],
            'optimizacion': ['performance', 'optimization', 'memo', 'useMemo', 'useCallback']
        }
    ...
    def run_extraction(self, raw_output="react_300_questions_raw.txt", 
                      structured_output="react_300_questions_structured.json"):
        """
        ...
        """
        print("🚀 Iniciando extracción de preguntas de React.js (300)")
        print("=" * 60)
...
def main():
    ...
    """
    # Configuración
    pdf_file = "300_ React.js Interview Questions and Answ - Salunke, Manish.pdf"
    raw_output = "react_300_questions_raw.txt"
    structured_output = "react_300_questions_structured.json"
    ...
    extractor = React300Extractor(pdf_file)
