#!/usr/bin/env python3
"""
Script para ejecutar el proceso completo de Java (540 preguntas)
...
def run_extraction():
    ...
    """
    return run_command(
        "python extract_java_540_questions.py",
        "Extrayendo preguntas del PDF de Java (540 preguntas)"
    )
...
def run_processing():
    ...
    """
    return run_command(
        "python process_java_540_questions.py",
...
def generate_guides():
    ...
    if not os.path.exists("java_540_questions_processed.json"):
        print("❌ No se encontró el archivo java_540_questions_processed.json")
        print("💡 Ejecuta primero el procesamiento")
        return False
    
    print("✅ Archivos procesados encontrados")
    print("📖 Las guías ya están generadas en:")
    print("   - Guia_Java_540_Avanzada.md")
    print("   - README.md")
...
def show_summary():
    ...
    files_to_check = [
        "java_540_questions_raw.txt",
        "java_540_questions_structured.json", 
        "java_540_questions_processed.json",
        "Guia_Java_540_Avanzada.md",
        "README.md"
    ]
    ...
    print("\n📊 Estadísticas:")
    if os.path.exists("java_540_questions_processed.json"):
        import json
        with open("java_540_questions_processed.json", 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def main():
    ...
    """
    print("☕ PROCESO COMPLETO DE JAVA (540 PREGUNTAS)")
    print("=" * 60)
    ...
    print("📚 Las guías de Java (540 preguntas) están listas para usar.")
