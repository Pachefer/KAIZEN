#!/usr/bin/env python3
"""
Script para extraer preguntas de Java del archivo PDF de 540 preguntas
Basado en el libro "540+ Java Interview Questions and Answers" de Salunke, Manish
"""
...
class Java540Extractor:
    def __init__(self, pdf_path):
        """
        Inicializa el extractor con la ruta del archivo PDF
        
        Args:
            pdf_path (str): Ruta al archivo PDF de Java (540 preguntas)
        """
    ...
    def extract_questions(self):
        ...
        # Patrones para identificar preguntas (adaptados para 540 preguntas de Java)
        question_patterns = [
    ...
    def categorize_questions(self):
        """
        Categoriza las preguntas por temas de Java
        """
        ...
        keywords = {
            'fundamentos': ['java', 'jvm', 'bytecode', 'compiler', 'runtime', 'main method', 'primitive', 'wrapper'],
            'oop': ['class', 'object', 'inheritance', 'polymorphism', 'encapsulation', 'abstraction', 'interface', 'abstract'],
            'colecciones': ['list', 'set', 'map', 'arraylist', 'linkedlist', 'hashset', 'treeset', 'hashmap', 'treemap'],
            'excepciones': ['exception', 'try', 'catch', 'finally', 'throw', 'throws', 'runtimeexception', 'checked'],
            'hilos': ['thread', 'runnable', 'synchronized', 'concurrent', 'executor', 'future', 'callable', 'volatile'],
            'streams': ['stream', 'lambda', 'functional', 'predicate', 'consumer', 'supplier', 'collector', 'optional'],
            'anotaciones': ['annotation', '@override', '@deprecated', '@suppresswarnings', '@functionalinterface'],
            'reflexion': ['reflection', 'class.forname', 'getclass', 'getmethod', 'getfield', 'invoke'],
            'genericos': ['generic', 'wildcard', 'extends', 'super', 'type parameter', 'erasure']
        }
    ...
    def run_extraction(self, raw_output="java_540_questions_raw.txt", 
                      structured_output="java_540_questions_structured.json"):
        """
        ...
        """
        print("🚀 Iniciando extracción de preguntas de Java (540)")
        print("=" * 60)
...
def main():
    ...
    """
    # Configuración
    pdf_file = "540_ Java Interview Questions and Answers - Salunke, Manish.pdf"
    raw_output = "java_540_questions_raw.txt"
    structured_output = "java_540_questions_structured.json"
    ...
    extractor = Java540Extractor(pdf_file)
