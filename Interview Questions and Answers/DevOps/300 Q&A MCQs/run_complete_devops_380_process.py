#!/usr/bin/env python3
"""
Script para ejecutar el proceso completo de DevOps (380 preguntas)
...
def run_extraction():
    ...
    """
    return run_command(
        "python extract_devops_380_questions.py",
        "Extrayendo preguntas del PDF de DevOps (380 preguntas)"
    )
...
def run_processing():
    ...
    """
    return run_command(
        "python process_devops_380_questions.py",
...
def generate_guides():
    ...
    if not os.path.exists("devops_380_questions_processed.json"):
        print("❌ No se encontró el archivo devops_380_questions_processed.json")
        print("💡 Ejecuta primero el procesamiento")
        return False
    
    print("✅ Archivos procesados encontrados")
    print("📖 Las guías ya están generadas en:")
    print("   - Guia_DevOps_380_Avanzada.md")
    print("   - README.md")
...
def show_summary():
    ...
    files_to_check = [
        "devops_380_questions_raw.txt",
        "devops_380_questions_structured.json", 
        "devops_380_questions_processed.json",
        "Guia_DevOps_380_Avanzada.md",
        "README.md"
    ]
    ...
    print("\n📊 Estadísticas:")
    if os.path.exists("devops_380_questions_processed.json"):
        import json
        with open("devops_380_questions_processed.json", 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def main():
    ...
    """
    print("🚀 PROCESO COMPLETO DE DEVOPS (380 PREGUNTAS)")
    print("=" * 60)
    ...
    print("📚 Las guías de DevOps (380 preguntas) están listas para usar.")
